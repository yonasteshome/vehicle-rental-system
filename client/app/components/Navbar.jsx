      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center gap-2">
            <div className="bg-orange-500 p-2 rounded-md text-white font-bold">
              🚗
            </div>
          ...
          <div className="hidden md:flex gap-8 text-sm font-semibold text-gray-200">
            ...
            <a href="#popular-sales" className="hover:text-orange-500 transition">
              Popular Sales
            </a>
          ...
          <div className="flex gap-4">
            ...
            <Link
              href="/auth"
              className="text-gray-200 font-semibold hover:text-orange-500 transition"
            >
              Login
            </Link>
            ...
            <Link
              href="/auth"
              className="bg-orange-500 px-6 py-2 rounded-lg font-bold text-white hover:bg-orange-400 transition"
            >
              Join Now
            </Link>
